...
class Controller(EventMixin):
  ...
  def _handle_ConnectionUp(self, event):
    ...
    # TODO: Check to see if the switch is connected to hosts, if so add hosts as node into graph and add the edges too.
    # Also, write a fxn to read the txt file to create a dict mapping (switch name, host name) to port #.
